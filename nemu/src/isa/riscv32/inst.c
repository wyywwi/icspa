...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT_START();
	...
	INSTPAT("0000000 ????? ????? 101 ????? 00100 11", slri   , I2, R(rd) = src1 >> imm);
	INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I2, R(rd) = (int32_t)src1 >> imm);
  ...
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul  	 , R , R(rd) = (uint64_t)src1 * (uint64_t)src2 );
